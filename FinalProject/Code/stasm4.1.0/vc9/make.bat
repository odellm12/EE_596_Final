...
@rem The following is a basic check that you have Visual Studio 9.0 on your path
@..\tools\which cl | ..\tools\egrep -i "Visual Studio 9.0.VC.bin.cl.exe" >NUL && goto doit
@echo Environment is not VC9 32 bit
@exit /B 1
:doit
